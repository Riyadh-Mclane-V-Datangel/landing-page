    ...
    <div>
      <nav className="navbar" data-aos="fade-up-right">
        <div className="max-width">
          ...
          <ul className="menu">
            <li><a href="#containerhttps://riyadh-mclane-v-datangel.github.io/landing-page2/" className="menu-btn">About Us</a></li>
            ...
            <li><a href="http://riyadh-mclane-v-datangel.github.io/sign-in//" className="menu-btn">Sign Up</a></li>
          </ul>
      ...
      <div className="button-wrapper">
        <a href="https://riyadh-mclane-v-datangel.github.io/landing-page2/" className="button">Learn More ➡️</a>
      </div>
      ...
      <div id="pre-selling" className="row">
        <div className="column">
          <div className="card">
            <img src={buildImage1} alt="Avatar" width="350" height="550" />
            <div className="card1">
        ...
        <div className="column">
          <div className="card">
            <img src={buildImage2} alt="Avatar" width="360" height="558" />
            <div className="card1">
      ...
      <div id="news-events" className="container4"><h4>News & Event</h4>
      ...
      <div className="footer">
        <footer>
          ...
          <div className="insta">
          <a href="https://www.instagram.com/irisclanetowerinc/"><img src={insta} alt="" width="30px" /></a>
          </div>
